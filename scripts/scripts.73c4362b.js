...
angular.module('project1App')
  .controller('ScheduleCtrl', function ($scope,Schedule) {
    ...
    $scope.fareRate = Schedule.fareRate;
  });
...
angular.module('project1App')
    .service('Schedule', function() {
        ...
        return {
            scheduleList: [{
                'route': 'Lucena to Marinduque',
                'time': ['02:30 am','03:30 am','07:30 am','10:30 am','11:30 am', '03:30 pm', '09:30 pm', '11:30 pm']
            },
            {
                'route': 'Marinduque to Lucena',
                'time': ['05:30 am','07:30 am', '11:30 am', '02:30 pm', '03:30 pm', '05:30 pm', '07:30 pm']
            }],
            fareRate: [
                {
                    'type': 'Regular',
